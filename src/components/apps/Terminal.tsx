    ...
    return (
      ...
      >
        ...
        <div className="font-avenir absolute text-center h-28 mx-auto -mt-20 bottom-0 left-0 right-0 top-1/2">
          ...
          <div className="text-3xl mt-4">HOW COULD YOU!</div>
          <div className="mt-4">Click to get safe</div>
        </div>
      </div>
    );
  }
      ...
      <div key={`terminal-input-row-${id}`} className="w-full h-6 flex">
        <div className="w-max hstack">
          <span className="text-yellow-200">
            lian@macpro <span className="text-green-300">{this.getCurDirName()}</span>
          </span>
    ...
    return (
      ...
      >
        ...
        <div className="w-full h-max pt-2 px-1.5 ">
          <span className="text-green-300">ヽ('_")ノ</span>: Hey, you got my terminal!
          Type `help` to get hacked.
        </div>
